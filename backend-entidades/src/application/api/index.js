...
module.exports = async function setupApi (app, services) {
  ...
  app.post('/auth/recuperar-contrasena', controllers.AuthController.recuperarContrasena);

  app.post('/auth/cambiar-contrasena', controllers.AuthController.cambiarContrasena);
